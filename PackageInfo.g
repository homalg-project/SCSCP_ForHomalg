#############################################################################
##  
##  PackageInfo.g for the package `SCSCP_ForHomalg'          Mohamed Barakat
##                                                       Alexander Konovalov
##
...
#
PackageName := "SCSCP_ForHomalg",

##  This may be used by a default banner or on a Web page, should fit on
##  one line.
Subtitle := "SCSCP Capabilities for the homalg Project",
...
# 
ArchiveURL := Concatenation( "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/SCSCP_ForHomalg/SCSCP_ForHomalg-", ~.Version ),
...
Persons := [
  ...
  rec(
    ...
    WWWHome       := "http://www.mathematik.uni-kassel.de/~hornp/",
    PostalAddress := Concatenation( [
                       "Peter Horn\n",
...
#
README_URL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/SCSCP_ForHomalg/README.SCSCP_ForHomalg",
PackageInfoURL := 
  "http://homalg.math.rwth-aachen.de/~barakat/homalg-project/SCSCP_ForHomalg/PackageInfo.g",
...
#
PackageWWWHome := "http://homalg.math.rwth-aachen.de/index.php/core-packages/scscpforhomalg",
AbstractHTML := 
"The <span class=\"pkgname\">SCSCP_ForHomalg</span> package launches an SCSCP connection to a local or remote SCSCP server\
with the <span class=\"pkgname\">RingsForHomalg</span> package loaded.",
#               
...
PackageDoc := rec(
  ...
  LongTitle := "SCSCP Capabilities for the GAP homalg Project",
...
BannerString := Concatenation( 
  "----------------------------------------------------------------\n",
  "Loading  SCSCP_ForHomalg ", ~.Version, "\n",
  ...
  "   ", ~.Persons[3].FirstNames, " ", ~.Persons[3].LastName,
        " (", ~.Persons[3].WWWHome, ")\n",
  "For help, type: ?SCSCP_ForHomalg package \n",
  "----------------------------------------------------------------\n" ),
